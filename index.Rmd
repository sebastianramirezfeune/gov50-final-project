...
cali_plot <- ggplot(cali_merge, aes(estimate)) + 
  geom_smooth(method = "loess", aes(y =percentage_white ), color = "orange", fill = "orange") + 
  geom_smooth(method = "loess",aes(y = percentage_black), color = "purple", fill = "purple") + 
  geom_smooth(method = "loess",aes(y =percentage_asian ), color = "turquoise", fill = "turquoise") + 
  geom_smooth(method = "loess",aes(y = percentage_native), color = "blue", fill = "blue")+
 geom_smooth(method = "loess",aes(y =percentage_hispanic ), color = "red", fill = "red") +
   labs(x = "Income", y = "Percentage of Each Race (Tract)", title = "Average Income per Population Percentage Based on Race", caption = "orange = white, purple = Black, turquoise = Asian, blue = Native, red = Hispanic") 
cali_plot
```
