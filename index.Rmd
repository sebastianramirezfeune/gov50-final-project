...
cali_plot <- ggplot(cali_merge, aes(estimate)) + 
  geom_smooth(aes(y =percentage_white ), color = "orange") + 
  geom_smooth(aes(y = percentage_black), color = "black") + 
  geom_smooth(aes(y =percentage_asian ), color = "turquoise") + 
  geom_smooth(aes(y = percentage_native), color = "blue")+
 geom_smooth(aes(y =percentage_hispanic ), color = "red") +
